...
public class EmployeeControllerTest {
    ...
    void should_create_new_employee_when_perform_post_given_new_employee() throws Exception {
        //given
        Employee newEmployee = new Employee("Jim", 20, "Male", 55000);
    ...
    void should_return_204_when_perform_delete_given_employee() throws Exception {
        //given
        Employee createdEmployee = employeeMongoRepository.save(new Employee("Jim", 20, "Male", 55000));
    ...
    @Test
    void should_return_not_found_when_perform_get_by_wrong_id_given_employees() throws Exception {
        client.perform(MockMvcRequestBuilders.get("/employees/{id}", "564654"))
                .andExpect(MockMvcResultMatchers.status().isNotFound());
    }

    @Test
    void should_return_bad_request_when_perform_put_given_not_exist_employee() throws Exception {
        client.perform(MockMvcRequestBuilders.put("/employees/{id}", "564654"))
